...
(function(a) {
    ...
    g(a, "Extensions/DownloadURL.js", [a["Core/Globals.js"]], function(a) {
        ...
        a = a.downloadURL = function(a, n) {
            ...
            if ("string" === typeof a ||
                a instanceof String || !e.msSaveOrOpenBlob) {
                a = "" + a;
                if (v || 2E6 < a.length)
    ...
    g(a, "Extensions/ExportData.js", [a["Core/Axis/Axis.js"], a["Core/Chart/Chart.js"],
        a["Core/Globals.js"], a["Core/Utilities.js"], a["Extensions/DownloadURL.js"]
    ], function(a, b, e, c, g) {
        function v(a, b) {
            var d = n.navigator,
            ...
            try {
                ...
                if (!f) return c.createObjectURL(new n.Blob(["\ufeff" + a], {
                    type: b
                }))
            } catch (N) {}
        }
        ...
        b.prototype.getDataRows = function(d) {
            ...
            var q = u.categoryHeader,
                ...
                H = function(k, b, f) {
                    ...
                    return k ? k instanceof a ? k.options.title && k.options.title.text || (k.dateTime ? y : q) : d ? {
        ...
        b.prototype.getTable = function(a) {
            ...
            !1 !== d.exporting.tableCaption && (b += '<caption class="highcharts-table-caption">' + x(d.exporting.tableCaption, d.title.text ? d.title.text.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;") : "Chart") + "</caption>");
            for (var t = 0, u = a.length; t < u; ++t) a[t].length >
                e && (e = a[t].length);
            b += function(a, b, c) {
                var e = "<thead>",
                    g = 0;
                ...
                if (h) {
                    for (e += "<tr>"; g < c; ++g) {
                        h = a[g];
                        var l = a[g + 1];
                        h === l ? ++m : m ? (e += p("th", "highcharts-table-topheading", 'scope="col" colspan="' + (m + 1) + '"', h), m = 0) : (h === b[g] ? d.exporting.useRowspanHeaders ? (l = 2, delete b[g]) : (l = 1, b[g] = "") : l = 1, e += p("th", "highcharts-table-topheading", 'scope="col"' + (1 < l ? ' valign="top" rowspan="' + l + '"' : ""),
                            h))
                    }
                    e += "</tr>"
                }
        ...
        b.prototype.downloadCSV = function() {
            var a = this.getCSV(!0);
            G(v(a, "text/csv") || "data:text/csv,\ufeff" + encodeURIComponent(a), this.getFilename() +
                ".csv")
        };
        ...
        b.prototype.viewData = function() {
            this.dataTableDiv || (this.dataTableDiv = C.createElement("div"), this.dataTableDiv.className = "highcharts-data-table", this.renderTo.parentNode.insertBefore(this.dataTableDiv, this.renderTo.nextSibling), this.dataTableDiv.innerHTML = this.getTable());
            if ("" === this.dataTableDiv.style.display || "none" ===
                this.dataTableDiv.style.display) this.dataTableDiv.style.display = "block";
        ...
        b.prototype.toggleDataTable = function() {
            ...
            this.isDataTableVisible ? this.hideData() :
                this.viewData();
            (null === p || void 0 === p ? 0 : p.menuItemDefinitions) && (null === c || void 0 === c ? 0 : c.viewData) && c.hideData && b && a && a.length && (a[b.indexOf("viewData")].innerHTML = this.isDataTableVisible ? c.hideData : c.viewData)
        };
        var p = L().exporting;
        p && (K(p.menuItemDefinitions, {
            downloadCSV: {
                textKey: "downloadCSV",
                onclick: function() {
                    this.downloadCSV()
        ...
        }), p.buttons && p.buttons.contextButton.menuItems.push("separator",
