    ...
    t.prototype = {
        ...
        _initializeDatasourceColors: function() {
            for (var e in this.options.dataSource)
                null == this.options.dataSource[e].color && (this.options.dataSource[e].color = a[e % a.length])
        },
        _render: function() {
            this.element.empty(),
            this._renderHeader(),
        ...
        _renderHeader: function() {
            ...
            s.addClass("glyphicon glyphicon-chevron-left"),
            a.append(s),
            n.append(a);
            var i = e(document.createElement("th"));
            i.addClass("year-title year-neighbor2 hidden-sm hidden-xs"),
            i.text(this.options.startYear - 2),
            null != this.options.minDate && this.options.minDate > new Date(this.options.startYear - 2,11,31) && i.addClass("disabled"),
            n.append(i);
        ...
        _renderBody: function() {
            ...
            for (var a = 0; 12 > a; a++) {
                ...
                if (this.options.displayWeekNumber) {
                    ...
                    c.addClass("week-number"),
                    c.text(n[this.options.language].weekShort),
                    u.append(c)
                }
                var h = n[this.options.language].weekStart;
                do {
                    var m = e(document.createElement("th"));
                    m.addClass("day-header"),
                    m.text(n[this.options.language].daysMin[h]),
                    u.append(m),
                    h++,
                    h >= 7 && (h = 0)
                } while (h != n[this.options.language].weekStart);r.append(u),
                o.append(r);
                for (var p = new Date(i.getTime()), g = new Date(this.options.startYear,a + 1,0), f = n[this.options.language].weekStart; p.getDay() != f; )
                ...
                for (; g >= p; ) {
                    ...
                    do {
                        ...
                        i > p)
                            ...
                            if (null != this.options.minDate && p < this.options.minDate || null != this.options.maxDate && p > this.options.maxDate)
                                y.addClass("disabled");
                            ...
                            v.text(p.getDate()),
                            y.append(v),
                            this.options.customDayRenderer && this.options.customDayRenderer(v, p)
                        }
                        D.append(y),
                        p.setDate(p.getDate() + 1)
                    } while (p.getDay() != f);o.append(D)
                }
                s.append(o),
                t.append(s)
            }
            ...
            null != this.options.dataSource && this.options.dataSource.length > 0 && this.element.find(".month-container").each(function() {
                ...
                if ((null == t.options.minDate || s >= t.options.minDate) && (null == t.options.maxDate || a <= t.options.maxDate)) {
                    ...
                    for (var o in t.options.dataSource)
                        (!(t.options.dataSource[o].startDate > s) || t.options.dataSource[o].endDate < a) && i.push(t.options.dataSource[o]);
        ...
        _renderDataSourceDay: function(e, t, n) {
            ...
            case "border":
                var a = 0;
                if (1 == n.length ? a = 4 : n.length <= 3 ? a = 2 : e.parent().css("box-shadow", "inset 0 -4px 0 0 black"),
                a > 0) {
                    var s = "";
                    for (var i in n)
                        "" != s && (s += ","),
                        s += "inset 0 -" + (parseInt(i) + 1) * a + "px 0 0 " + n[i].color;
        ...
        _applyEvents: function() {
            ...
            n.bind("contextmenu", function(n) {
                t.options.enableContextMenu && (n.preventDefault(),
                t.options.contextMenuItems.length > 0 && t._openContextMenu(e(this)));
                var a = t._getDate(e(this));
            ...
            this.options.enableRangeSelection && (n.mousedown(function(n) {
                if (1 == n.which) {
                    var a = t._getDate(e(this));
                    (t.options.allowOverlap || 0 == t.getEvents(a).length) && (t._mouseDown = !0,
            ...
            n.mouseenter(function(n) {
                if (t._mouseDown) {
                    ...
                    if (!t.options.allowOverlap) {
                        ...
                        if (a > s)
                            for (var i = new Date(s.getFullYear(),s.getMonth(),s.getDate() + 1); a > s && !(t.getEvents(i).length > 0); )
                                s.setDate(s.getDate() + 1),
                                i.setDate(i.getDate() + 1);
                        else
                            for (var i = new Date(s.getFullYear(),s.getMonth(),s.getDate() - 1); s > a && !(t.getEvents(i).length > 0); )
                                s.setDate(s.getDate() - 1),
                                i.setDate(i.getDate() - 1);
                        a = s
                    }
            ...
            setInterval(function() {
                var n = e(t.element).width()
                  ...
                  , s = "month-container";
                s += n > 6 * a ? " col-xs-2" : n > 4 * a ? " col-xs-3" : n > 3 * a ? " col-xs-4" : n > 2 * a ? " col-xs-6" : " col-xs-12",
        ...
        _openContextMenu: function(t) {
            ...
            n.length > 0 ? (n.hide(),
            n.empty()) : (n = e(document.createElement("div")),
            n.addClass("calendar-context-menu"),
            e("body").append(n));
            ...
            for (var i in s) {
                ...
                o.addClass("item"),
                o.css("border-left", "4px solid " + s[i].color);
            ...
            n.children().length > 0 && (n.css("left", t.offset().left + 25 + "px"),
        ...
        _renderContextMenuItems: function(t, n, a) {
            ...
            for (var i in n)
                if (!n[i].visible || n[i].visible(a)) {
                    ...
                    d.addClass("glyphicon glyphicon-chevron-right"),
                    o.append(d),
                    n[i].items && n[i].items.length > 0 && this._renderContextMenuItems(o, n[i].items, a),
                    s.append(o)
                }
        ...
        getEvents: function(e) {
            ...
            if (this.options.dataSource && e)
                for (var n in this.options.dataSource)
                    this.options.dataSource[n].startDate <= e && this.options.dataSource[n].endDate >= e && t.push(this.options.dataSource[n]);
            return t
        },
        getYear: function() {
        ...
        setLanguage: function(e) {
            null != e && null != n[e] && (this.options.language = e,
            this._render())
        },
