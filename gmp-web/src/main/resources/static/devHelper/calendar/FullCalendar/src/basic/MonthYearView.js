...
fcViews.monthYear = MonthYearView;

function MonthYearView( element, calendar ) {
    var t = this;
    BasicView.call( t, element, calendar, 'monthYear' );
    ...
    /**
     *  MonthYearView > Render
     */
    function render( date, delta )
    {
        //      debug
        //console.log( "MonthYearView > render" );
    ...
    function buildSkeleton( maxRowCnt, showNumbers ) {
        ...
        s = "<table border='1' style='width:100%' cellspacing='0'>";
        for ( i = 0; i < 4; i++ ) {
...
//            for ( j = 0; j < 4; j++ ) {
//                month_nb++;
//                s +=  "<th class='fc- " + headerClass + " month-" + month_nb + "'>";
//                
//            }
//            s += "</tr>";
//        }
...
//                  
//                  s += '<thead>';
//                  s += '<tr class="fc-first fc-last">';
//                  s +=  '<th class="fc-sun fc-widget-header fc-first" style="width: 127px;">Sun</th>';
//                  s +=  '<th class="fc-mon fc-widget-header" style="width: 127px;">Mon</th>';
//                  s +=  '<th class="fc-tue fc-widget-header" style="width: 127px;">Tue</th>';
//                  s +=  '<th class="fc-wed fc-widget-header" style="width: 127px;">Wed</th>';
//                  s +=  '<th class="fc-thu fc-widget-header" style="width: 127px;">Thu</th>';
//                  s +=  '<th class="fc-fri fc-widget-header" style="width: 127px;">Fri</th>';
//                  s +=  '<th class="fc-sat fc-widget-header fc-last">Sat</th>';
//                  s += '</tr>';
//                  s += '</thead>';
//                  s += '<tbody>';
//                  s += '</tbody>';
	...
	function updateCells( firstTime )
	{
		...
		if (dowDirty)
		{
			headCells.each(function(i, _cell)
			{
				...
				//     In MonthYearView, each col is a month
