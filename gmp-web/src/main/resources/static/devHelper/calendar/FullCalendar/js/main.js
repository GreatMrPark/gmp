...
var calendar = $('#calendar').fullCalendar({
 ...
 /** ******************
  ...
  navLinks                  : true,
  defaultDate               : moment(gThisMonth), //실제 사용시 현재 날짜로 수정
  timeFormat                : 'HH:mm',
  ...
  header                    : {
                                left   : 'today, prevYear, nextYear, viewWeekends, viewYears',
  ...
  customButtons             : { //주말 숨기기 & 보이기 버튼
                                ...
                                viewYears : {
                                  text  : '년',
                                  click : function () {
                                      activeInactiveYears ? activeInactiveYears = false : activeInactiveYears = true;
                                    $('#calendar').fullCalendar('option', { 
                                      years: activeInactiveYears
                                    });
                                  }
                                }
                               },
